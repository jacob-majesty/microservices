package com.majesty.accounts.controller;

import com.majesty.accounts.constants.AccountsConstants;
import com.majesty.accounts.dto.AccountsContactInfoDto;
import com.majesty.accounts.dto.CustomerDto;
...
@Tag(name = "CRUD REST APIs for Accounts in the Bank", description = "CRUD REST APIs in the Bank to CREATE, UPDATE, FETCH AND DELETE account details")
...
public class AccountsController {
        ...
        @Operation(summary = "Create Account REST API", description = "REST API to create new Customer &  Account inside the Bank")
        @ApiResponses({
